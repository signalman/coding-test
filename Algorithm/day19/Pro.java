...
class Pro {
    ...
    private void combination(int cur, int N, int[][] dice, List<Integer> a, List<Integer> b){
        if(cur == N){
    ...
    private void rollDice(int cur, int N, int[] getNumbers, int[][] dice, List<Integer> a, boolean flag){
